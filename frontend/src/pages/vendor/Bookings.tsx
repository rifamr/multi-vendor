...
import { Calendar, Check, X, Video } from "lucide-react";
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <div className="flex gap-1">
                        ...
                        {b.status === "accepted" && (b.paymentStatus === "paid" || b.paymentStatus === "success") && b.videoConsultationEnabled === true && (
                          <button
                            onClick={() => navigate(`/video-consultation?bookingId=${b.id}&role=vendor`)}
