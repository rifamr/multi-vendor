...
import { XCircle, Calendar, FileText, Star, RefreshCw, Video } from "lucide-react";
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        {(b.paymentStatus === "paid" || b.paymentStatus === "success") && b.status === "accepted" && b.videoConsultationEnabled === true && (
                          <button
                            onClick={() => navigate(`/video-consultation?bookingId=${b.id}&role=customer`)}
                            className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-purple-500/10 text-purple-400 hover:bg-purple-500/20 border border-purple-500/20 text-xs transition-colors"
